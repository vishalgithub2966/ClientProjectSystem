...
var CodeView = /** @class */ (function () {
    ...
    function encodeScriptTag(str) {
        str = str.replace(/<script[\s\S]*?/gi, encodeURI('<script'));
        str = str.replace(/<\/script[\s\S]*?>/gi, encodeURI('</script>'));
        return str;
    }

    function decodeScriptTag(str) {
        var openTag = new RegExp("" + encodeURI('<script') + "", "gi");
        var closeTag = new RegExp("" + encodeURI('</script>') + "", "gi");
        str = str.replace(openTag, decodeURI('<script'));
        str = str.replace(closeTag, decodeURI('</script>'));
        str = str.replace(/&gt;/gi, ">");
        return str;
    }
    ...
    CodeView.prototype.activate = function () {
        ...
        if (env.hasCodeMirror) {
            this.$codable[0].value = decodeScriptTag(this.$codable[0].value);
    ...
    CodeView.prototype.deactivate = function () {
        ...
        if (env.hasCodeMirror) {
            ...
            cmEditor.setValue(encodeScriptTag(cmEditor.getValue()));
