...
function Directory(fullPath, numDirs, numFiles){
  ...
  this.GetHtml = function(){
     var html = '<li data-path="'+this.fullPath+'" data-dirs="'+this.dirs+'" data-files="'+this.files+'" class="directory">';
      html += '<div><img src="lib/fileman/images/'+(this.dirs > 0?'dir-plus.png':'blank.gif')+'" class="dirPlus" width="9" height="9">';
      html += '<img src="lib/fileman/images/folder.png" class="dir"><span class="name">'+this.name+' ('+this.files+')</span></div>';
     html += '</li>';
  ...
  this.SetOpened = function(){
    ...
    if(li.find('li').length < 1)
        li.children('div').children('.dirPlus').prop('src', 'lib/fileman/images/blank.gif');
    else if(this.IsExpanded())
        li.children('div').children('.dirPlus').prop('src', 'lib/fileman/images/dir-minus.png');
    else
        li.children('div').children('.dirPlus').prop('src', 'lib/fileman/images/dir-plus.png');
  };
...
function switchView(t){
  ...
  if(t == 'thumb'){
    $('#pnlFileList .icon').attr('src', 'lib/fileman/images/blank.gif');
