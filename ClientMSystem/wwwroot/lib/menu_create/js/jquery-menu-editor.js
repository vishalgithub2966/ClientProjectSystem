...
function MenuEditor(idSelector, options) {
    var $main = $("#" + idSelector);
    var settings = {
        labelEdit: '<i class="flaticon-interface-3 clickable"></i>',
    ...
    $(document).on('click', '.btnRemove', function (e) {
        ...
        if (confirm(settings.textConfirmDelete)){
            ...
            $("#menuItems option[value='" + liId + "']").remove();
    ...
    $(document).on('click', '.btnEdit', function (e) {
        ...
        e.preventDefault();
        $("#menuItems option").removeAttr("style");
        itemEditing = $(this).closest('li');
        $(".edit-li-show").removeClass("edit-li-show");
        $(this).closest('li').addClass('edit-li-show');
        $("#menuItems option[value='" + itemEditing.attr("id") + "']").css("display", "none");
        console.log(itemEditing.html());
        editItem(itemEditing);
        
        $("#btnAdd").addClass('d-btn-none');
        $('#btnUpdate').removeClass('d-btn-none');
    });
    ...
    function TButtonGroup() {
        ...
        var $btnEdit = TButton({ classCss: 'btn btn-primary btn-xs btnEdit', text: '<i class="flaticon-interface-3 clickable"></i>'});
        var $btnRemv = TButton({ classCss: 'btn btn-danger btn-xs btnRemove', text: '<i class="fa fa-trash clickable"></i>'});
    ...
    this.menuItem = function () {
        ...
        var $li = $("<li>").data(data);
        $li.addClass('list-group-item').append(div);
        $li.attr("id", $("#menuItems option:last").val());
        $main.append($li);
        MenuEditor.updateButtons($main);
        $("#NewMenuAdd").val("");
        resetForm();
